...
void setup(void)
{
    ...
    // Create a new face
    face = new Face(
        /* screenWidth = */ 128, /* screenHeight = */ 64, /* eyeSize = */ 40
    );
    ...
    // Automatically switch between behaviours (selecting new behaviour randomly
    // based on the weight assigned to each emotion)
...
void loop()
{
    ...
    // To avoid making eyes too twitchy (and to allow time for previous move
    // animation to end), only recalculate new position every 500ms
